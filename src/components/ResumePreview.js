      ...
      >
        <div ref={printElem}>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "maryam1234@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+923001234567"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Islamabad, Pakistan"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                ...
                {educationList.map((education) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text fontSize={"sm"}>
                        {school ? school : "Fatima Jinnah Woman University, Rawalpindi"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
                      ...
                      >
                        <Text>
                          {startYr ? startYr : 2023} - {endYr ? endYr : 2027}
                        </Text>
                        <Text>{grade ? grade : "XX CGPA"}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
